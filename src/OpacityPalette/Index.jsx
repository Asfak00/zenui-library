        ...
        <>
            <section className="min-h-screen w-full pt-[9.5rem] 1024px:pt-[7rem] !px-5 425px:!px-10 relative">
                ...
                <div className="mt-6 relative w-[50%]">
                    ...
                    <button
                        onClick={addColor}
                        className="py-2 h-full text-[1.1rem] px-6 text-gray-500 hover:text-white transition-all duration-200 bg-gray-300 hover:bg-[#0FABCA] rounded-r-md absolute top-0 right-0"
                    >
                        Generate
                    </button>
                </div>
