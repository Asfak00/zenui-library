...
import {MdDone, MdOutlineCall, MdOutlineEmail} from "react-icons/md";
import {CgFacebook} from "react-icons/cg";
import {BsCashStack, BsInstagram, BsLinkedin, BsTwitter} from "react-icons/bs";
                                ...
                                <div className='w-full flex items-center gap-[10px]'>
                                    {
                                        steps1?.map((stepItem, index)=> (
                                            <>
                                                {
                                                    step1 <= stepItem.id && (
                                                        <p className={`w-[34%] h-[40px] text-gray-500 flex items-center justify-center text-[1.2rem] rounded-full bg-gray-50`}>{stepItem?.id}</p>
                                                    )
                                                }

                                                {
                                                step1 >= (stepItem.id + 1) && (
                                                        <MdDone className='p-[10px] w-[20%] h-[40px] rounded-full bg-blue-500 text-white'/>
                                                    )
                                                }

                                                <p className={`${step1 > stepItem.id ? 'text-blue-500' : 'text-gray-600'} text-[0.9rem] font-[400] w-[75%]`}>{stepItem?.name}</p>
                                            ...
                                            <div className='flex flex-col gap-[20px] w-full'>
                                                ...
                                                <div className='w-full'>
                                                    ...
                                                    <label
                                                        ...
                                                        <p className='flex items-center gap-[5px] text-[1rem] mt-2'>
                                ...
                                <div className='w-full flex items-center gap-[10px]'>
                                    {
                                        steps?.map((stepItem, index) => (
                                            <>
                                                ...
                                                } w-[21%] h-[40px] flex items-center justify-center text-[1.2rem] rounded-full bg-blue-500`}>{stepItem?.id}</p>
                                                {
                                            ...
                                            <>
                                                ...
                                                <div className='mt-6 flex items-center gap-[20px]'>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className='text-[0.9rem] font-[300] text-gray-400 w-[80%] mt-1'>Lorem
