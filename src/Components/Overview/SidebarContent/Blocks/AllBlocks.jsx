...
const AllBlocks = () => {
    ...
    AllBlocksData?.map((componentObj) => {
        if (componentObj.groupName === "section") {
            sections.push(componentObj);
            return;
        }
        if (componentObj.groupName === "form") {
            forms.push(componentObj);
            return;
        }
        if (componentObj.groupName === "empty_page") {
            emptyPages.push(componentObj);
            return;
        }
        if (componentObj.groupName === "random") {
            randoms.push(componentObj);
            return;
        }
    });
