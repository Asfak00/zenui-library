    ...
    return (
        <aside className="flex items-start justify-between gap-6 pt-[9.5rem] !px-5 425px:!px-10 1024px:!pl-[5rem] 1024px:pt-[4.5rem]">
            <div>
                ...
                <div className="w-full border border-border rounded mt-8">
                    ...
                    {searchbarPreview && (
                        <div className={` ${inputFocus ? 'pb-18' : 'pb-8'} p-8 transition-all duration-300 flex flex-wrap items-center gap-5 justify-center overflow-hidden`}>
                            ...
                            <div className="relative w-[80%] product_search_input">
                                ...
                                <IoIosSearch className='absolute top-[9px] left-2 text-[1.5rem] text-[#adadad]'/>
                                        ...
                                        <div className={`${inputFocus ? 'opacity-100 h-auto translate-y-0 mt-2' : 'translate-y-[-10px] opacity-0 h-0'} product_search_bar bg-white boxShadow w-full transition-all duration-500 overflow-hidden flex flex-col rounded-md`}>
                                                ...
                                                filteredData?.map((product)=> (
                                                    <div key={product?.id}
                                                        ...
                                                        <div className='flex items-center gap-[10px]'>
                                                            ...
                                                            <h1 className='text-[1.1rem] text-gray-700 font-[400]'>{truncate(product?.name, 60)}</h1>
                                                        </div>
                                            ...
                                            {
                                                !filteredData?.length && (
                                                    <p className='text-[0.9rem] text-[#a0a0a0] text-center'>No search matched!</p>
                                                )
                                            }
                                                        ...
                                                        recentsData?.map((data,index)=> (
                                                            <div key={index}
                                                                ...
                                                                <div className='flex items-center gap-[10px]'>
                                                                    ...
                                                                    <h3 className='text-[1rem]'>{data?.title}</h3>
                                                                    <div
                ...
                <div className='mt-8'>
                    <ContentHeader text={"Search bar open with keypress"} id={"search_bar_with_actions"} />
                </div>
                                                            ...
                                                            <div key={index}
                                                                ...
                                                                <div className='flex items-center gap-[15px]'>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p className='text-[0.8rem] text-gray-500'>{people.email}</p>
                                                                    </div>
                                                                </div>
