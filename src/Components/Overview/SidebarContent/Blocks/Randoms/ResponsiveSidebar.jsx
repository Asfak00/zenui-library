                        ...
                        <div className={` p-8 pb-[80px] transition-all duration-300 flex flex-wrap items-center gap-5 overflow-hidden`}>
                            ...
                            <aside className={`bg-white boxShadow rounded-md transition-all duration-300 ease relative`}>
                                ...
                                <div className={`${isCollapse2 ? 'justify-between px-[20px]' : 'justify-center px-[10px]'} bg-gray-50 py-3 flex items-center mt-10`}>
                                    <div className={`${isCollapse2 ? 'inline' : 'hidden'} flex items-center bg-gray-200 p-[10px] rounded-md w-full justify-between relative`}>
                                        <div className={`${isDark ? 'w-[110px] translate-x-[121px]': 'w-[110px] translate-x-0'} transition-all duration-300 absolute top-[50%] transform translate-y-[-50%] left-[4px] bg-white rounded-md h-[85%] w-[100px] z-10`}></div>
                                        <button className={`px-[15px] py-[3px] rounded-md flex items-center gap-[10px] text-[1rem] text-gray-500 z-20`} onClick={()=> setIsDark(false)}>
                                            <IoSunnyOutline className='text-[1.2rem]'/>
                                            Light
                                        </button>
                                        <button className={`px-[15px] py-[3px] rounded-md flex items-center gap-[10px] text-[1rem] text-gray-500 z-20`} onClick={()=> setIsDark(true)}>
