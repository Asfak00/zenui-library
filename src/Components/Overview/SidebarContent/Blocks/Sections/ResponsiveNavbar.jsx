                            ...
                            <nav
                                ...
                                <div className='flex items-center gap-[15px]'>
                                    ...
                                    <CiMenuFries onClick={()=> setMegaMenuOpen(!megaMenuOpen)}
                                        className='text-[1.8rem] text-textc cursor-pointer 1024px:hidden flex'/>
                                </div>
            ...
            <aside
                ...
                <ul className="items-start gap-[20px] text-[1rem] text-gray-600 flex flex-col">
                    <li onClick={() => setProductMobileMegaMenu(!productMobileMegaMenu)}
                        ...
                        Products
                        <IoIosArrowDown
                            className={`${productMobileMegaMenu ? "rotate-0" : "rotate-[180deg]"} text-gray-600 group-hover:text-primary transition-all duration-300`}/>
                    </li>
                    ...
                    <div onClick={() => setMegaMenuSubItem("more_product")}
                        ...
                        <ul className={`${megaMenuSubItem === "more_product" ? "flex" : "hidden"} pl-6 mt-3 font-[400] items-start flex-col gap-[10px] text-gray-600`}>
                            <li className="hover:text-primary transition-all duration-500 cursor-poin ter capitalize">Demo
                                App
                            </li>
                            <li className="hover:text-primary transition-all duration-500 cursor-poin ter capitalize">CRM</li>
                            <li className="hover:text-primary transition-all duration-500 cursor-poin ter capitalize">CMS</li>
                    ...
                    <div onClick={() => setMegaMenuSubItem("ecosystem")}
                        ...
                        <ul className={`${megaMenuSubItem === "ecosystem" ? "flex" : "hidden"} pl-6 mt-3 font-[400] items-start flex-col gap-[10px] text-gray-600`}>
                            <li className="hover:text-primary transition-all duration-500 cursor-poin ter capitalize">Directory</li>
                            <li className="hover:text-primary transition-all duration-500 cursor-poin ter capitalize">Bookings</li>
                            <li className="hover:text-primary transition-all duration-500 cursor-poin ter capitalize">User
                                feedback
                            </li>
                            <li className="hover:text-primary transition-all duration-500 cursor-poin ter capitalize">Task
                                Manager
                            </li>
                        </ul>
                    </div>
                        ...
                        <div
                            ...
                            <nav
                                ...
                                <div className='items-center gap-[10px] flex'>
                                    ...
                                    <CiMenuFries className='text-[1.8rem] mr-1 text-textc cursor-pointer 1024px:hidden flex'
                                                 onClick={() => setBasicNavbarOpen(!basicNavbarOpen)}/>
                                </div>
...
const ResponsiveNavbar = () => {
    ...
    return (
        <nav
            ...
            <div className="items-center gap-[10px] flex">
                <button
                    className="py-[7px] text-[1rem] px-[16px] rounded-full capitalize hover:text-primary transition-all duration-300 sm:flex hidden">Sign
                    in
                </button>
                <button
                    className="py-[7px] text-[1rem] px-[16px] rounded-full capitalize bg-primary text-white hover:bg-blue-400 transition-all duration-300 sm:flex hidden">Sign
                    up
                </button>
