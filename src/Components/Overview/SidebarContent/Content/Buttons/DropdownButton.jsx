    ...
    Click Me
          ...
          '/>}
                ...
                <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
                    ...
                    {actionButtonPreview && (
                        <div className={`p-8 ${actionButtonActive ? 'mb-32' : 'mb-4'} flex flex-wrap items-center gap-5 justify-center transition-all duration-300`}>
                            <div className='flex items-center rounded bg-primary border-none outline-none text-secondary justify-between relative'>
                                <button
                                    className=" text-[1rem] px-6 py-1.5 transition-all duration-500 cursor-auto">
                                    {sendButtonText}
                                ...
                                <ul className={`${actionButtonActive ? 'opacity-100 z-20 translate-y-4' : ' opacity-0 z-[-1] translate-y-[-20px]'} publishButtonOptions transition-all duration-500 flex flex-col boxShadow bg-white py-1 w-max w-full absolute top-[46px] rounded border border-[#e6e6e6] right-0 text-text text-[0.9rem]`}>
