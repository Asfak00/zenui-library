...
export default Textarea;
          ...
          <div className="mt-8">
            <ContentHeader text={"Strong Password Checking"} id={"strong_password_checking"}/>
          </div>
...

                      {
                          StrongPassword !== '' && (
                              <p className={`${signal === 'normal' ? 'text-red-500' : 'text-green-600'} text-[0.9rem] mt-1`}>
                                {
                                  signal === 'normal' ? 'Password must be greater then 8 character!' : 'Wow! Very strong password.'
                                }
                              </p>
                          )
                      }
