      ...
      <aside>
        <div className="p-4 flex gap-2 w-[80%] bg-[#d18f0011] border border-[#d18e00]  rounded mb-8">
          ...
          <p className="text-[#d18e00] text-[0.9rem]">
            When you use the notification message from here in your project, be
            sure to note a few things like "z-index", "position", "onClick
            handler" etc. Because we're giving you the structure here, your job
            is to associate the notification with where you want to use it.
          </p>
        </div>

        <ContentHeader text={"border notification"} />
...
export default Notification;
        ...
        <div className="mt-8">
          <ContentHeader text={"cross icon notification"} />
        </div>
...
export default Notification;
        ...
        <div className="mt-8">
          <ContentHeader text={"customize postioning notification"} />
        </div>
