...
const AlertMessage = () => {
  ...
  return (
    <>
      <aside>
        <ContentHeader text={"alert message with background"} />
...
export default AlertMessageWithBackground;
        ...
        <div className="mt-8">
          <ContentHeader text={"alert message with title"} />
        </div>
...
export default AlertMessageWithTitle;
        ...
        <div className="mt-8">
          <ContentHeader text={"alert message with border"} />
        </div>
...
export default AlertMessageWithBorder;
        ...
        <div className="mt-8">
          <ContentHeader text={"message take action"} />
        </div>
