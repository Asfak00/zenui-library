            ...
            {socialPostPreview && (
                <div className="p-8 mb-4 flex items-center gap-5 justify-center">
                  <div className='flex flex-col gap-[20px]'>
                    <div className="w-full 425px:w-[450px] bg-secondary p-3 rounded-md border border-border boxShadow animate-pulse">
        ...
        '
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            ...
            {socialPostPreview && (
                <div className="p-8 mb-4 flex items-center gap-5 justify-center">
                  <div className='flex flex-col gap-[20px]'>
                      <div className="w-full 425px:w-[450px] bg-secondary p-4 rounded-md border border-border boxShadow animate-pulse">
