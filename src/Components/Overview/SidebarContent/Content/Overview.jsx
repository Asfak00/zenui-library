      ...
      <aside className='w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
          ...
          <div className="mt-8 w-full text-text">
              ...
              <ul className="flex flex-col gap-3 list-disc pl-4 mt-3">
                  ...
                  <li className="p-0 hover:bg-transparent border-none hover:border-none hover:font-[400] hover:bg-secondary">
                      <b>Opacity Palette:</b> Introducing the custom color opacity palette. A versatile tool that allows you to explore different opacity variations of colors. Simply paste your color code, and the palette will generate a range of opacity levels along with the corresponding HEX, RGB, and HSL codes. Clicking on a color code instantly copies it to your clipboard, making color management a breeze.
                  </li>
              </ul>
          </div>
          ...
          <div className="mt-8 w-full text-text">
              ...
              <ul className="flex flex-col gap-3 list-disc pl-4 mt-3">
                  <li className="p-0 hover:bg-transparent border-none hover:border-none hover:font-[400] hover:bg-secondary">
                      <b>No Dependencies Needed:</b> ZenUI is entirely standalone, just copy the code and use it. No external dependencies or additional setups are required, making integration fast and hassle-free.
                  </li>
                  <li className="p-0 hover:bg-transparent border-none hover:border-none hover:font-[400] hover:bg-secondary">
