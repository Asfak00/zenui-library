...
// icons
import {BsArrowRight, BsEye, BsThreeDots, BsThreeDotsVertical} from "react-icons/bs";
import {
...
import {BiComment, BiLike, BiRightArrow, BiRightArrowAlt, BiSolidLeaf} from "react-icons/bi";
...
export default PricingCard;
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            ...
            {pricingCard2Preview && (
                <div className="p-8 mb-4 flex items-center gap-5 justify-center">
                  <div className='bg-white rounded-md boxShadow min-w-[60%]'>
                    <img
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            ...
            {pricingCard2Preview && (
                <div className="p-8 mb-4 flex items-center gap-5 justify-center">
                  <div className='bg-white rounded-md boxShadow min-w-[70%] max-w-[80%]'>
                    <img
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            ...
            {pricingCard2Preview && (
                <div className="p-8 mb-4 flex items-center gap-5 justify-center">
                  <div
                      className='bg-white rounded-md boxShadow min-w-[60%] px-4 py-8 flex items-center justify-center flex-col'>
                    <img
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            ...
            {pricingCard2Preview && (
                <div className="p-8 mb-4 flex items-center gap-5 justify-center">
                  <div className='min-w-[60%] max-w-[75%] relative bg-white boxShadow rounded-xl'>
                    <img
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            ...
            {pricingCard2Preview && (
                <div className="p-8 mb-4 flex items-center gap-5 justify-center">
                  <div className='min-w-[60%] max-w-[90%] relative bg-white boxShadow rounded-xl flex gap-[20px] p-4'>
                    <div className='w-[25%]'>
                      <img
                          ...
                          alt='image'
                          className='w-[100%] h-[100px] object-cover rounded-full'
                      />
                    </div>
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            ...
            {pricingCard2Preview && (
                <div className="p-8 mb-4 flex items-center gap-5 justify-center">
                  <div className='bg-white boxShadow rounded-md max-w-[80%]'>
                    <div className='p-5'>
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            ...
            {pricingCard2Preview && (
                <div className="p-8 mb-4 flex items-center gap-5 justify-center">
                  <div className='bg-white boxShadow rounded-md max-w-[80%] px-2'>
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            ...
            {pricingCard2Preview && (
                <div className="p-8 mb-4 flex items-center gap-5 justify-center">
                  <div className='max-w-[80%] boxShadow rounded-md'>
                    <div className='flex items-center justify-between w-full p-4'>
            ...
            {pricingCard2Preview && (
                <div className="p-8 mb-4 flex items-center gap-5 justify-center">
                  <div className='max-w-[80%] boxShadow rounded-md'>
                    ...
                    <div className='mt-4'>
                      <div className='flex items-center w-full justify-between py-3 hover:bg-gray-100 px-4'>
                        ...
                        <button className='py-2 px-6 bg-purple-500 text-white rounded-md'>Follow</button>
                      </div>
