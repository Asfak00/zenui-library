...
export default ArrowTooltip;
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${relativeAnimationPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[100px] rounded-br'}`}></div>
              <button
                  className={`${
            ...
            {relativeAnimationPreview && (
                <div className="p-8 pb-20 mb-4 pt-20 flex items-center flex-col gap-5 justify-center overflow-hidden">
                  <div className="flex items-center gap-6 flex-wrap">
                    ...
                    <div className=" relative group">
                      ...
                      <div
                          className=" absolute top-0.5 left-[-100px] translate-x-[-20px] opacity-0 z-[-1] group-hover:translate-x-0 group-hover:opacity-100 group-hover:z-[1] transition-all duration-500">
                    ...
                    <div className=" relative group">
                      ...
                      <div
                          className=" absolute top-[-45px] left-[-23px] translate-y-[-20px] opacity-0 z-[-1] group-hover:translate-y-0 group-hover:opacity-100 group-hover:z-[1] transition-all duration-500">
                        <p className="text-[0.9rem] w-max bg-[#8d8d8d] text-secondary rounded px-3 py-2 ">
                          Top Tooltip
                        </p>
                      </div>
                    ...
                    <div className=" relative group">
                      ...
                      <div
                          className=" absolute bottom-[-45px] left-[-20px] translate-y-[20px] opacity-0 z-[-1] group-hover:translate-y-0 group-hover:opacity-100 group-hover:z-[1] transition-all duration-500">
                        <p className="text-[0.9rem] w-max bg-[#8d8d8d] text-secondary rounded px-3 py-2 ">
                          Bottom Tooltip
                        </p>
                      </div>
                    ...
                    <div className=" relative group">
                      ...
                      <div
                          className=" absolute top-0.5 right-[-110px] translate-x-[20px] opacity-0 z-[-1] group-hover:translate-x-0 group-hover:opacity-100 group-hover:z-[1] transition-all duration-500">
                        <p className="text-[0.9rem] w-max bg-[#8d8d8d] text-secondary rounded px-3 py-2 ">
                          Right Tooltip
                        </p>
                      </div>
