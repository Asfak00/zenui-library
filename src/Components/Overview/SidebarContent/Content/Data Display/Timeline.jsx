    ...
    return (
        <>
                ...
                <div>
                    ...
                    <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
                        <div className="relative">
                            <div
                                className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${milestoneTimelinePreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[100px] rounded-br'}`}></div>
                            <button
                                className={`${
                        ...
                        {milestoneTimelinePreview && (
                            <div className="p-8 mb-4 flex items-center flex-col gap-5 justify-center">
                                <div className="max-w-4xl mx-auto p-6">
                                    <h1 className="text-3xl font-bold mb-16">Milestone Timeline</h1>
                                            ...
                                            <div key={index} className="mb-8">
                                                ...
                                                <div className="pl-6">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div
                                                            className="ml-4 text-text text-lg font-semibold">{milestone.title}</div>
                                                    </div>
          ...
          '
                    ...
                    <p className="w-full 425px:w-[80%] text-text text-[1rem]">
                        This is a cart badge component. Show cart items or notifications with a stylish and visible
                        badge.
                    </p>
                    ...
                    <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
                        <div className="relative">
                            <div
                                className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${workHistoryPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[100px] rounded-br'}`}></div>
                            <button
                                className={`${
