        ...
        <div>
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${alertModalPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default Modal;
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${successModalPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default Modal;
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${infoModalPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default DropDown;
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${permissionModalPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default DropDown; 
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            ...
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${formModalPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default DropDown;
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            ...
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${cookieModalPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default DropDown;
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${fullScreenModalPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default DropDown;
          ...
          <p className="w-full 425px:w-[80%] text-text text-[1rem]">
            A modal that slides in from the side of the screen, providing a compact and accessible way to display additional content.
          </p>

          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${customizeModalPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default Modal;
          ...
          <p className="w-full 425px:w-[80%] text-text text-[1rem]">
            A delete confirmation modal that requires users to type the word "delete" to validate and confirm the action, ensuring intentional deletion.
          </p>

          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${deleteModalPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
                    ...
                    >
                      ...
                      <div className="w-full">
                        ...
                        <div className='mt-5'>
                          ...
                          <input onChange={checkDeleteModalChange} type='text' className='py-3 px-4 border border-gray-200 rounded-md mt-1 w-full outline-none focus:border-primary'/>
                        </div>

                        <div className='mt-8 flex w-full items-end justify-end gap-[13px]'>
                          <button onClick={()=> setModal10Open(false)} className={`py-2 px-6 rounded font-[500] z-10 border border-[#cecece] text-gray-500`}>Cancel</button>
                          <button onClick={() => setModal10Open(false)} className={`${utils.buttonPrimary} ${disabledButton ? '!bg-[#FDECEB] !border-[#FDECEB] text-red-200 cursor-not-allowed' : 'bg-red-600 text-white border-red-600'}`} disabled={disabledButton}>Yes, Delete</button>
                        </div>
                      </div>
                    </div>
                  </div>
...
export default Modal;
          ...
          <OverviewFooter backUrl='/components/stepper' backName='stepper' forwardName='tabs' forwardUrl='/components/tabs'/>
        </div>
