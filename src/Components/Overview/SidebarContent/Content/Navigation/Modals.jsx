...
export default SlideModal;
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${deleteModalPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[100px] rounded-br'}`}></div>
              <button
                  className={`${
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="w-full">
                        ...
                        <div className='mt-5'>
                          <label className='font-[500] text-text'>Type "DELETE" to confirm</label> <br/>
                          <input onChange={checkDeleteModalChange} type='text' className='py-3 px-4 border border-[#cecece] rounded-md mt-1 w-full outline-none focus:border-primary'/>
                        </div>
