        ...
        <>
            <aside className="flex items-start justify-between gap-6 pt-[9.5rem] !px-5 425px:!px-10 1024px:!pl-[5rem] 1024px:pt-[4.5rem]">
                <div>
                    ...
                    <div className="mt-8">
                        <ContentHeader text={"progress bar with counting"} id={"progress_bar_with_counting"}/>
                    </div>
                    ...
                    <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
                        <div className="relative">
                            <div
                                className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${countingPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[100px] rounded-br'}`}></div>
                            <button
                                className={`${
                        ...
                        {circlePreview && (
                            <div className="p-8 mb-4 mt-8 flex flex-col items-start gap-5 justify-center">
                                <div className="relative w-[150px] h-[150px] mx-auto">
                                    ...
                                    <p className='absolute top-[35%] left-[32%] translate-x-1/2 transform translate-y-1/2'>{progress}%</p>
                                </div>
                ...
                <div className="1024px:flex hidden flex-col gap-4 sticky top-20 right-0 w-[40%]">
                    ...
                    <a
                        href="#progress_bar_with_counting"
                        className={`${
