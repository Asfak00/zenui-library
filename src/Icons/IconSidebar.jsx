    ...
    return (
        <aside className={`${sidebarOpen ? 'translate-x-0' : 'translate-x-[500px]'} w-[30%] bg-white fixed top-0 right-0 boxShadow min-h-screen transition-all z-30 duration-300 iconsSidebar pt-[7rem] px-12`}>
            ...
            <div className='relative'>
                <RxCross1 className='p-[8px] absolute top-[-20px] left-[-30px] rounded-full transition-all duration-100 hover:bg-gray-100 text-[2rem] text-gray-800 cursor-pointer' onClick={handleCrossClick}/>
            </div>
